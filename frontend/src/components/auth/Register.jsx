...
const Register = () => {
  ...
  return (
<div className="h-screen w-screen flex items-center justify-center text-white px-4">
  <form
    className="w-full max-w-[22rem] border-[1px] rounded-xl p-6 flex flex-col bg-[#00000096] border-none items-center"
  ...
  >
    ...
    {registerWith === "phone" ? (
      <div className="flex flex-col mb-2 gap-[2px] w-full">
        ...
        />
        <p
          className="text-[11px] text-yellow-600 cursor-pointer"
      ...
      <div className="flex flex-col mb-2 gap-[2px] w-full">
        ...
        />
        <p
          className="text-[11px] text-yellow-600 cursor-pointer m-0 p-[0px]"
          onClick={toggleRegisterWith}
        >
          Register with phone
        </p>
    ...
    <button
      type="submit"
      className="bg-blue-400 font-medium py-1 rounded-[5px] mt-5 w-full"
    >
      Register
    </button>
